...
**Outcome:** Built a production-style DevOps/MLOps project with Docker and Docker Compose workflows, GitHub Actions checks, deterministic tests, structured JSON logs without image payloads, and documented safety boundaries that avoid recognition, identity matching, attractiveness scoring, or sensitive attribute inference.
